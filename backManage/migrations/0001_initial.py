# Generated by Django 2.2.13 on 2020-10-14 15:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 5014, tzinfo=utc), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
            name='Instructor',
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 6068, tzinfo=utc), verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 9724, tzinfo=utc), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
            name='Member',
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 7096, tzinfo=utc), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 8128, tzinfo=utc), verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 10, 14, 15, 42, 37, 8666, tzinfo=utc))),
                ...
                ('paper_cc', models.FileField(null=True, upload_to='cc', validators=[django.core.validators.FileExtensionValidator(['pdf'], message='文件必须为pdf格式')], verbose_name='查重报告pdf版')),
